  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 glass-panel fixed top-[50%] left-[50%] z-50 max-h-[min(90dvh,calc(100vh-2rem))] w-[min(90vw,calc(100vw-2rem))] max-w-2xl translate-x-[-50%] translate-y-[-50%] overflow-y-auto overscroll-contain rounded-xl p-4 duration-200 data-[state=closed]:animate-out data-[state=open]:animate-in sm:p-6',
          className,
        )}
        {...props}
      >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        'font-mono text-muted-foreground text-xs uppercase tracking-wider',
        className,
      )}
      {...props}
    />
