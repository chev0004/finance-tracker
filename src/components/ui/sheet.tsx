  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 fixed z-50 flex flex-col gap-4 border border-border bg-card shadow-lg duration-300 ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in',
          side === 'right' &&
