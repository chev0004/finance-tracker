          ...
          >
            <div
              className={cn(
                ...
                'bg-card/85 shadow-[0_24px_64px_-12px_rgba(0,0,0,0.45),0_0_0_1px_rgba(255,255,255,0.04)_inset]',
                'backdrop-blur-xl backdrop-saturate-150',
                'dark:bg-card/70 dark:shadow-[0_24px_64px_-12px_rgba(0,0,0,0.65)]',
              )}
            >
